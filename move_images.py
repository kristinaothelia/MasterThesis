...
container_file = 'datasets/Full_aurora_new_rt_predicted_efficientnet-b3_corr.json'
#container_file = 'datasets/Full_aurora_new_rt_ml_predicted_efficientnet-b3_corr.json' # NB! remember to make folders!
