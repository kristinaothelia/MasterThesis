...
train(json_file, model_name[1], ep=200, batch_size_train=32, learningRate=0.01, stepSize=100, g=0.1)
train(json_file, model_name[1], ep=200, batch_size_train=64, learningRate=0.01, stepSize=100, g=0.1)
train(json_file, model_name[1], ep=200, batch_size_train=64, learningRate=0.1, stepSize=100, g=0.1)
...
train(json_file, model_name[2], ep=200, batch_size_train=32, learningRate=0.01, stepSize=100, g=0.1)
train(json_file, model_name[3], ep=200, batch_size_train=32, learningRate=0.01, stepSize=100, g=0.1)
