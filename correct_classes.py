...
predicted_file = 'datasets/Full_aurora_new_rt_predicted_efficientnet-b3_TESTNEW.json'
corrected_file = 'datasets/Full_aurora_new_rt_predicted_efficientnet-b3_TESTNEW.json'
